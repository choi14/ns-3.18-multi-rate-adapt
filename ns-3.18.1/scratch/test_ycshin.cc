...
//	NS_LOG_UNCOND("State change time Current Time: " << Simulator::Now().GetSeconds() << " Duration: " << duration ); 
...
main (int argc, char *argv[])
{
	...
	Config::SetDefault("ns3::WifiMacQueue::MaxPacketNumber", UintegerValue(8000));
  ...
  */
	...
	NS_LOG_UNCOND("Source node sent: " << nc_k*((onof->GetTotalTx()/1000)/nc_k));
