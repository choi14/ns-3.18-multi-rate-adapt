...
FeedbackHeader::Serialize (Buffer::Iterator start) const
{
  ...
  start.WriteHtonU32 (m_totalPacket);
	start.WriteU8 (m_perRate.perMCS0);
	start.WriteU8 (m_perRate.perMCS1);
	start.WriteU8 (m_perRate.perMCS2);
	start.WriteU8 (m_perRate.perMCS3);
	start.WriteU8 (m_perRate.perMCS4);
	start.WriteU8 (m_perRate.perMCS5);
	start.WriteU8 (m_perRate.perMCS6);
	start.WriteU8 (m_perRate.perMCS7);
}
uint32_t
FeedbackHeader::Deserialize (Buffer::Iterator start)
{
	...
	m_perRate.perMCS0 = i.ReadU8 ();
	m_perRate.perMCS1 = i.ReadU8 ();
	m_perRate.perMCS2 = i.ReadU8 ();
	m_perRate.perMCS3 = i.ReadU8 ();
	m_perRate.perMCS4 = i.ReadU8 ();
	m_perRate.perMCS5 = i.ReadU8 ();
	m_perRate.perMCS6 = i.ReadU8 ();
	m_perRate.perMCS7 = i.ReadU8 ();
